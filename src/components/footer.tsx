	...
	return (
		<footer class="px-4 py-2 gap-4 w-full text-xs italic flex justify-between items-end">
			<a href="https://cafecito.app/mciparelli" rel="noreferrer" target="_blank">
				<img alt="Invitame un café en cafecito.app" src="https://cdn.cafecito.app/imgs/cafecito_logo.svg" class="w-10 h-[36px]" />
			</a>
			<div class="flex gap-4">
				<a href="https://t.me/mciparelli" target="_blank" rel="noreferrer">
					<img alt="Telegram" src="https://www.svgrepo.com/show/452115/telegram.svg" class="w-6 h-6" />
				</a>
				<a href="https://x.com/mciparelli" target="_blank" rel="noreferrer" aria-label="Mi cuenta de X">
					<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 h-6 bi bi-twitter-x" viewBox="0 0 16 16">
