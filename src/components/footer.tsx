	...
	return (
		<footer class="px-4 py-2 gap-4 w-full text-xs italic flex justify-between items-end">
			<a href="https://cafecito.app/mciparelli" rel="noreferrer" target="_blank">
				<img src="https://cdn.cafecito.app/imgs/cafecito_logo.svg" alt="Invitame un café en cafecito.app" class="w-10" />
			</a>
			<div class="flex gap-4">
				...
				<a href="https://x.com/mciparelli" target="_blank" rel="noreferrer">
